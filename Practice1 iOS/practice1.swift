...
//  
//
//  Created by Suleimenova Zhasmin on 13.09.2025.
//

import Foundation
let firstName: String = "Zhasmin"
let lastName: String = "Suleimenova"
let currentYear: Int = 2025
let birthYear: Int = 2004
let age: Int = currentYear - birthYear
let isStudent: Bool = true
let statusOfStudent: String = isStudent ? "student 👩🏻‍🎓" : "not a student"
let height: Double = 1.55
let weight: Double = 52
let numberOfSiblings: Int = 1
let hobby: String = "Reading 📖"
let favoriteBook: String = "Marin Eden"
let nuberOfHObbies: Int = 5
let favoriteNumber: Int = 14
